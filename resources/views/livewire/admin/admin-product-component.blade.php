                                        ...
                                        @foreach ( $products as $product )
                                            <tr>
                                                ...
                                                <td class="cell">
                                                    ...
                                                    {{-- <a class="btn-sm app-btn-secondary mr-2" wire:click.prevent="deleteCategory({{ $category->id }})" href="#">Delete</a> --}}
                                                    <a class="btn-sm app-btn-secondary" href="{{ route('admin.editproduct',['product_slug'=> $product->slug ]) }}">Update</a>
                                                    <a class="btn-sm app-btn-secondary" href="#" wire:click.prevent = 'deleteProduct({{ $product->id }})'>Delete</a>                                                </td>
                                            </tr>
                                        @endforeach
